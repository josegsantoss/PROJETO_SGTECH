...
--
-- Table structure for table `tabela_teste`
--
...
--
-- Dumping data for table `tabela_teste`
--

LOCK TABLES `tabela_teste` WRITE;
/*!40000 ALTER TABLE `tabela_teste` DISABLE KEYS */;
/*!40000 ALTER TABLE `tabela_teste` ENABLE KEYS */;
UNLOCK TABLES;
